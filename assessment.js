...
// to the library, ensuring that the new book new book has all required properties (title, author,
// publicationYear, and isAvailable).
function addNewBook(books){
  books.push({ title: 'The Flying Bird', author: 'Job', publicationYear: 1930,
     isAvailable: true })
